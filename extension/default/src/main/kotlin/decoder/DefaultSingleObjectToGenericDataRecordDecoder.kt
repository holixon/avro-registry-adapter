...
/**
 * Uses default [BinaryMessageDecoder] and given [SchemaResolver] to decode the single object
 * bytes to a generic record.
 */
class DefaultSingleObjectToGenericDataRecordDecoder(private val schemaResolver: SchemaResolver) : SingleObjectToGenericDataRecordDecoder {
